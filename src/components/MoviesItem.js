...
import {redirectToEpisodes} from "../redux/action";
            ...
            <div className='card-item'>
                <Row className="card-item-background">
                    ...
                    <Col xs={7} md={8} lg={7} className="item-description">
                        ...
                        <button className='card-item-btn mt-2' onClick={() => props.redirectToEpisodes(id)}>Show
                            Episodes
                        </button>
                    </Col>
                </Row>
...
const mapDispatchToProps = (dispatch) => ({
    redirectToEpisodes: (showId) => dispatch(redirectToEpisodes(showId)),
});
